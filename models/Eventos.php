...
class Eventos extends Model{
    ...
    public function saveNuevoEvento($id_presupuesto,  $horasAd, $encargado, $descripcion){
        ...
        if(!is_numeric("$horasAd")) throw new ValidationException('horasAd no es un número');
        if($horasAd < 0 ) throw new ValidationException('horasAd no puede ser menor a 0');
